...
then
    ...
    wget -c https://ai2-vision-alfred.s3-us-west-2.amazonaws.com/json_2.1.0.7z
...
then
    ...
    wget -c https://ai2-vision-alfred.s3-us-west-2.amazonaws.com/json_feat_2.1.0.7z
...
then
    ...
    wget -c https://ai2-vision-alfred.s3-us-west-2.amazonaws.com/full_2.1.0.7z
